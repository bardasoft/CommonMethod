...
namespace CommonMethod
{
    public class FTPHelper
    {
        ...
        public class UpdataProgressValue
        {
            public int Total
            {
                get;
        ...
        //public static string ftpURI = "ftp://" + FtpServerIP + "/";
        public static string ftpURI = "" + FtpServerIP + "/";
        #endregion
        ...
        public static bool FtpDownload(string remoteFileName, string localFileName, bool ifCredential, Action<UpdataProgressValue> updateProgress = null)
        {
            ...
            try
            {
                ...
                if (updateProgress != null)
                {
                    ...
                    updateProgress(new UpdataProgressValue { Total = (int)totalBytes, Current = 0 });//更新进度条   
                }
                ...
                while (readCount > 0)
                {
                    ...
                    if (updateProgress != null)
                    {
                        ...
                        updateProgress(new UpdataProgressValue { Total = (int)totalBytes, Current = (int)totalDownloadedByte });//更新进度条   
                    }
                    readCount = ftpStream.Read(buffer, 0, bufferSize);
                }
                ftpStream.Close();
        ...
        /// <param name="updateProgress">报告进度的处理(第一个参数：总大小，第二个参数：当前进度)</param>
        /// <returns>是否下载成功</returns>
        public static bool FtpBrokenDownload(string remoteFileName, string localFileName, bool ifCredential, long size, Action<UpdataProgressValue> updateProgress = null)
        {
            FtpWebRequest reqFTP, ftpsize;
            Stream ftpStream = null;
            FtpWebResponse response = null;
        ...
        /// <returns>是否下载成功</returns>
        public static bool FtpDownload(string remoteFileName, string localFileName, bool ifCredential, bool brokenOpen, Action<UpdataProgressValue> updateProgress = null)
        {
            if (brokenOpen)
            {
                try
        ...
        /// <param name="updateProgress">报告进度的处理(第一个参数：总大小，第二个参数：当前进度)</param>
        /// <returns>是否下载成功</returns>
        public static bool FtpUploadFile(string localFullPathName, Action<UpdataProgressValue> updateProgress = null)
        {
            ...
            try
            {
                ...
                if (updateProgress != null)
                {
                    ...
                    updateProgress(new UpdataProgressValue { Total = (int)allbye, Current = 0 });//更新进度条   
                }
                int startbye = 0;
                while (contentLen != 0)
                {
                    ...
                    if (updateProgress != null)
                    {
                        ...
                        updateProgress(new UpdataProgressValue { Total = (int)allbye, Current = (int)startbye });//更新进度条   
                    }
                    contentLen = fs.Read(buff, 0, buffLength);
                }
                stream.Close();
        ...
        /// <param name="updateProgress">报告进度的处理(第一个参数：总大小，第二个参数：当前进度)</param>
        /// <returns></returns>       
        public static bool FtpUploadBroken(string localFullPath, string remoteFilepath, Action<UpdataProgressValue> updateProgress = null)
        {
            ...
            if (updateProgress != null)
            {
                ...
                updateProgress(new UpdataProgressValue { Total = (int)allbye, Current = (int)startfilesize });//更新进度条   
            }
            ...
            else
            {
                ...
                //uri =  FtpServerIP + "/" + remoteFilepath + "/" + newFileName;
                //uri = "ftp://192.168.2.19:8008/SK_VideoRecord/0001/";
            }
            FtpWebRequest reqFTP;
