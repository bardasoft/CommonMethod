...
namespace DBOperAt
{
    ...
    public abstract class DBHelpMySql
    {
        ...
        //public static string connectionString = "server=192.168.18.130;Port=3308; user id=root;password=mypassword;database=AlarmServer";
        public static string connectionString = PubConstant.MySqlDBConnectionString;
        public DBHelpMySql()
        {
